...
class TCStereo(nn.Module):
    ...
    def forward(self, image1, image2,  K=None, T=None, previous_T=None, last_disp=None, last_net_list=None, 
                fmap1=None, baseline=None, test_mode=False, frame_id=0):
        ...
        if previous_T is not None:  # not the first frame
            # intrinsic matrix
            K = K  # b,3,3
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', help="dataset for evaluation", required=False,
